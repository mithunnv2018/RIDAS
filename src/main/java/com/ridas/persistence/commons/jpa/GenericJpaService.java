...
import com.ridas.persistence.PersistenceConfig;
...
public abstract class GenericJpaService<T, PK extends java.io.Serializable> {
	...
	public List<T> loadAll() {
		...
		JpaOperation operation = new JpaOperation() {
			@Override
			public Object exectue(EntityManager em) throws PersistenceException {
				final Query query = em.createQuery("from " + persistentClass.getName()+" where status='active' " );
	 ...
	 * @param primaryKey
	 */
	public boolean delete(final PK primaryKey,final String pkcolumnname) {
		// JPA operation definition 
		JpaOperation operation = new JpaOperation() {
			@Override
			public Object exectue(EntityManager em) throws PersistenceException {
    			...
    			Query createQuery = em.createQuery("UPDATE "+entityname+" s SET s.status = :paramstatus WHERE s."+pkcolumnname+"= :parampk");
    			createQuery.setParameter("paramstatus", "dormant");
    			createQuery.setParameter("parampk", primaryKey);
